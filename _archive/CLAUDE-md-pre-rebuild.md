...
The repo `Omri-Linx-Skills` (at `~/code/Omri-Linx-Skills`) contains Omri's role-level Claude Skills. When Omri asks to manage his skills, route through this section.
